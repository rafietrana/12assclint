...
const FeturedTest = () => {
  const { data: getsortfeturedtest = [], isLoading, isError } = useQuery({
    queryKey: ["repoData"],
    queryFn: () =>
      axios("http://localhost:5000/getsortfeturedid").then((res) => res.data),
  });
  ...
  return (
    <div className="w-full lg:w-11/12 mx-auto    px-4 md:px-10 mt-36 mb-10">
    {/* title section start */}
        <div className="mb-10">
          <div className="flex flex-col justify-center items-center">
            ...
            <div>
              {" "}
              <motion.p className="  text-lg   md:text-[30px] font-Outfit text-[#000D44] font-[600] text-center md:leading-[50px]   "
