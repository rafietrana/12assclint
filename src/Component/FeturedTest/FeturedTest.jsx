...
const FeturedTest = () => {
    const { data:getsortfeturedtest=[] } = useQuery({
        queryKey: ['repoData'],
        queryFn: () =>
           axios('http://localhost:5000/getsortfeturedid')
        .then(res =>{
            return res.data;
        })
      })
        ...
        <div>
          ...
          >
            ...
            <div className="card-body">
              ...
              <p className="text-center">{pageTestGet.date  && pageTestGet.date.split("T")[0]}</p>
              ...
              <p className="text-center">
                {pageTestGet?.testdetails    &&pageTestGet?.testdetails.slice(0, 50)}...
              </p>
